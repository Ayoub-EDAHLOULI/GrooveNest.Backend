...
{
    public class AuthenticationService(IUserRepository userRepository, IUserRoleRepository userRoleRepository, JwtTokenService jwtTokenService) : IAuthenticationService<LoginDto, UserAuthResponseDto>
    {
